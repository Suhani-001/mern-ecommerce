                ...
                <div className="collect__item__actions">
                    <div className="add__cart__add__wish">
                        <div className="add__cart">
                            <Button variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: 'var(--grey)', borderColor: 'var(--grey)', borderWidth: '3px', color: 'black'}, minWidth: 200, borderColor: 'black', backgroundColor: "black" , color: "var(--grey)", borderWidth: '3px'}]} onClick={handelAddToCart}>ADD TO BAG</Button>
                        </div>
                        <div className="add__wish">
                            <IconButton variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: 'var(--grey)', borderColor: 'var(--grey)', borderWidth: '3px', color: 'black'}, borderColor: 'black', backgroundColor: "black" , color: "var(--grey)", borderWidth: '3px'}]} onClick={handelAddToWish}>
